...
export default function TalentGallery({ talentData, isVisible, setIsVisible }) {
  ...
  return (
    <div className={`absolute ${isVisible ? "transition-opacity-active" : "transition-opacity hidden"} top-32 md:top-80 left-0 items-end justify-end pb-6 almostWhite flex flex-col gap-10 z-20 overflow-hidden w-full`}>
